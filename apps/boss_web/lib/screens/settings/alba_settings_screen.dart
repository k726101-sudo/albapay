...
import 'resignation_create_screen.dart';
          ...
          Center(
            child: Column(
              children: [
                ...
                TextButton(
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (_) => const ResignationCreateScreen()));
                  },
                  child: Text('퇴사 신청 (사직서 제출)', style: TextStyle(color: Colors.grey.shade400, fontSize: 11)),
                ),
              ],
            ),
          ),
