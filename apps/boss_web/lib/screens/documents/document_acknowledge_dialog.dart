...
class _DocumentAcknowledgeDialogState extends State<DocumentAcknowledgeDialog> {
  ...
  Widget build(BuildContext context) {
    final isWageStatement = widget.document.type == DocumentType.wageStatement;
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              isWageStatement
                  ? '${widget.document.title}가 도착했습니다. 상세 내역을 확인해 주세요.'
            ...
            ElevatedButton(
                  ...
                  : () {
                      if (isWageStatement) {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) => DocumentReadOnlyScreen(
              ...
              child: _isProcessing
                  ...
                  : Text(
                      isWageStatement ? '명세서 상세 보기' : '서류를 확인했으며 교부에 동의합니다',
