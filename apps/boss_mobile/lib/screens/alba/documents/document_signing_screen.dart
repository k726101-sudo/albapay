  ...
  Future<void> _handleSign() async {
    ...
    try {
      ...
      for (final bundleDoc in bundleDocs) {
        final closedDoc = LaborDocument(
          id: bundleDoc.id,
          storeId: bundleDoc.storeId,
          staffId: bundleDoc.staffId,
          type: bundleDoc.type,
          title: bundleDoc.title,
          content: bundleDoc.content,
          createdAt: bundleDoc.createdAt,
          signedAt: bundleDoc.signedAt ?? now,
          signatureUrl: bundleDoc.signatureUrl,
          status: 'signed',
          sentAt: bundleDoc.sentAt,
