...
class Attendance {
  ...
  /// AUTO_PENDING | AUTO_CONFIRMED | EDITED | PAYROLL_CLOSED | LOCKED | REOPENED
  final String attendanceStatus;

  /// 이전 상태 백업 (LOCKED -> REOPENED 변환 시, 원래의 상태가 AUTO_PENDING이었는지 EDITED였는지 등을 보존하기 위해 사용)
  ...
  /// 엔진에 의해 스케줄 기반으로 자동 생성된 가상 출퇴근 기록 여부 (네거티브 UX 용도)
